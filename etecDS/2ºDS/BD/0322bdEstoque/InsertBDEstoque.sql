...
values
	...
	, ('Paulo Henrique Silva', '87395451588', 'phsilva80@hotmail.com', 'm', '02/02/1987')
...
values
	('Atacadão', 'Carlos Santana')
	, ('Assai', 'Maria Stella')
	, ('Roldão', 'Paulo César')

insert into tbProduto (descrProduto, valorProduto, qtdProduto, codFabricante, codFornecedor)
values 
	('Amaciante Downey', 5.76, 1500, 2, 1)
...
insert into tbItemVenda (codVenda, codProduto, qtdItemVenda, subTotalItemVenda)
values 
	(1, 1, 200, 1500)
	, (1, 2, 300, 3000)
	, (2, 4, 120, 1400)
